-- Create stored procedures for initializing tables from client-side code

-- Create island_groups table procedure
CREATE OR REPLACE FUNCTION create_island_groups_table()
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
...
-- Create regions table procedure
CREATE OR REPLACE FUNCTION create_regions_table()
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
    -- Create island_groups first if it doesn't exist
    PERFORM create_island_groups_table();
...
-- Create annual_budgets table procedure
CREATE OR REPLACE FUNCTION create_annual_budgets_table()
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
...
-- Create region_budgets table procedure
CREATE OR REPLACE FUNCTION create_region_budgets_table()
RETURNS void
LANGUAGE plpgsql
AS $$
BEGIN
    -- Create regions table first if it doesn't exist
    PERFORM create_regions_table();
